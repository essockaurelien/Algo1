...
//printf("upo_bst_key_list_t key_list = NULL.\n");
    bst = upo_bst_create(int_compare);

    assert( bst != NULL );

    /* BST: empty tree */
//printf("fin qua sono del prof che sono cose giuste.\n");
    ref_lo_key = min_key;
    ref_hi_key = max_key;
    ...
    ref_lo_key = min_key;
    ref_hi_key = mid_key;
//printf("da qua il prof usa il tuo casino brutto stronzo sei l'unico responsabile risolvilo.\n");    
    key_list = upo_bst_keys_range(bst, &ref_lo_key, &ref_hi_key);
